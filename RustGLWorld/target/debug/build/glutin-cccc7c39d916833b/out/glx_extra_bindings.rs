...
pub type Pixmap = XID;
pub type Visual = ();
pub type VisualID = super::__gl_imports::libc::c_ulong;
pub type Window = XID;
...
impl Glx {
            ...
            pub fn load_with<F>(mut loadfn: F) -> Glx where F: FnMut(&str) -> *const __gl_imports::libc::c_void {
...
WaitX: FnPtr::new(metaloadfn("glXWaitX", &[])),
        ...
        #[allow(dead_code)]
        #[allow(unused_variables)]
        pub fn load<T: __gl_imports::gl_common::GlFunctionsSource>(loader: &T) -> Glx {
            Glx::load_with(|name| loader.get_proc_addr(name))
        }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn ChooseFBConfig(&self, dpy: *mut types::Display, screen: __gl_imports::libc::c_int, attrib_list: *const __gl_imports::libc::c_int, nelements: *mut __gl_imports::libc::c_int) -> *mut types::GLXFBConfig { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, __gl_imports::libc::c_int, *const __gl_imports::libc::c_int, *mut __gl_imports::libc::c_int) -> *mut types::GLXFBConfig>(self.ChooseFBConfig.f)(dpy, screen, attrib_list, nelements) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn ChooseVisual(&self, dpy: *mut types::Display, screen: __gl_imports::libc::c_int, attribList: *mut __gl_imports::libc::c_int) -> *mut types::XVisualInfo { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, __gl_imports::libc::c_int, *mut __gl_imports::libc::c_int) -> *mut types::XVisualInfo>(self.ChooseVisual.f)(dpy, screen, attribList) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn CopyContext(&self, dpy: *mut types::Display, src: types::GLXContext, dst: types::GLXContext, mask: __gl_imports::libc::c_ulong) -> () { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, types::GLXContext, types::GLXContext, __gl_imports::libc::c_ulong) -> ()>(self.CopyContext.f)(dpy, src, dst, mask) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn CreateContextAttribsARB(&self, dpy: *mut types::Display, config: types::GLXFBConfig, share_context: types::GLXContext, direct: types::Bool, attrib_list: *const __gl_imports::libc::c_int) -> types::GLXContext { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, types::GLXFBConfig, types::GLXContext, types::Bool, *const __gl_imports::libc::c_int) -> types::GLXContext>(self.CreateContextAttribsARB.f)(dpy, config, share_context, direct, attrib_list) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
...
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn GetClientString(&self, dpy: *mut types::Display, name: __gl_imports::libc::c_int) -> *const __gl_imports::libc::c_char { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, __gl_imports::libc::c_int) -> *const __gl_imports::libc::c_char>(self.GetClientString.f)(dpy, name) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn GetConfig(&self, dpy: *mut types::Display, visual: *mut types::XVisualInfo, attrib: __gl_imports::libc::c_int, value: *mut __gl_imports::libc::c_int) -> __gl_imports::libc::c_int { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, *mut types::XVisualInfo, __gl_imports::libc::c_int, *mut __gl_imports::libc::c_int) -> __gl_imports::libc::c_int>(self.GetConfig.f)(dpy, visual, attrib, value) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
...
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn GetFBConfigAttrib(&self, dpy: *mut types::Display, config: types::GLXFBConfig, attribute: __gl_imports::libc::c_int, value: *mut __gl_imports::libc::c_int) -> __gl_imports::libc::c_int { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, types::GLXFBConfig, __gl_imports::libc::c_int, *mut __gl_imports::libc::c_int) -> __gl_imports::libc::c_int>(self.GetFBConfigAttrib.f)(dpy, config, attribute, value) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn GetFBConfigs(&self, dpy: *mut types::Display, screen: __gl_imports::libc::c_int, nelements: *mut __gl_imports::libc::c_int) -> *mut types::GLXFBConfig { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, __gl_imports::libc::c_int, *mut __gl_imports::libc::c_int) -> *mut types::GLXFBConfig>(self.GetFBConfigs.f)(dpy, screen, nelements) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
...
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn GetSelectedEvent(&self, dpy: *mut types::Display, draw: types::GLXDrawable, event_mask: *mut __gl_imports::libc::c_ulong) -> () { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, types::GLXDrawable, *mut __gl_imports::libc::c_ulong) -> ()>(self.GetSelectedEvent.f)(dpy, draw, event_mask) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
...
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn QueryContext(&self, dpy: *mut types::Display, ctx: types::GLXContext, attribute: __gl_imports::libc::c_int, value: *mut __gl_imports::libc::c_int) -> __gl_imports::libc::c_int { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, types::GLXContext, __gl_imports::libc::c_int, *mut __gl_imports::libc::c_int) -> __gl_imports::libc::c_int>(self.QueryContext.f)(dpy, ctx, attribute, value) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn QueryDrawable(&self, dpy: *mut types::Display, draw: types::GLXDrawable, attribute: __gl_imports::libc::c_int, value: *mut __gl_imports::libc::c_uint) -> () { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, types::GLXDrawable, __gl_imports::libc::c_int, *mut __gl_imports::libc::c_uint) -> ()>(self.QueryDrawable.f)(dpy, draw, attribute, value) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn QueryExtension(&self, dpy: *mut types::Display, errorb: *mut __gl_imports::libc::c_int, event: *mut __gl_imports::libc::c_int) -> types::Bool { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, *mut __gl_imports::libc::c_int, *mut __gl_imports::libc::c_int) -> types::Bool>(self.QueryExtension.f)(dpy, errorb, event) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn QueryExtensionsString(&self, dpy: *mut types::Display, screen: __gl_imports::libc::c_int) -> *const __gl_imports::libc::c_char { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, __gl_imports::libc::c_int) -> *const __gl_imports::libc::c_char>(self.QueryExtensionsString.f)(dpy, screen) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn QueryServerString(&self, dpy: *mut types::Display, screen: __gl_imports::libc::c_int, name: __gl_imports::libc::c_int) -> *const __gl_imports::libc::c_char { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, __gl_imports::libc::c_int, __gl_imports::libc::c_int) -> *const __gl_imports::libc::c_char>(self.QueryServerString.f)(dpy, screen, name) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn QueryVersion(&self, dpy: *mut types::Display, maj: *mut __gl_imports::libc::c_int, min: *mut __gl_imports::libc::c_int) -> types::Bool { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, *mut __gl_imports::libc::c_int, *mut __gl_imports::libc::c_int) -> types::Bool>(self.QueryVersion.f)(dpy, maj, min) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn SelectEvent(&self, dpy: *mut types::Display, draw: types::GLXDrawable, event_mask: __gl_imports::libc::c_ulong) -> () { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, types::GLXDrawable, __gl_imports::libc::c_ulong) -> ()>(self.SelectEvent.f)(dpy, draw, event_mask) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
...
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn SwapIntervalEXT(&self, dpy: *mut types::Display, drawable: types::GLXDrawable, interval: __gl_imports::libc::c_int) -> () { __gl_imports::mem::transmute::<_, extern "system" fn(*mut types::Display, types::GLXDrawable, __gl_imports::libc::c_int) -> ()>(self.SwapIntervalEXT.f)(dpy, drawable, interval) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn SwapIntervalSGI(&self, interval: __gl_imports::libc::c_int) -> __gl_imports::libc::c_int { __gl_imports::mem::transmute::<_, extern "system" fn(__gl_imports::libc::c_int) -> __gl_imports::libc::c_int>(self.SwapIntervalSGI.f)(interval) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
            #[inline] pub unsafe fn UseXFont(&self, font: types::Font, first: __gl_imports::libc::c_int, count: __gl_imports::libc::c_int, list: __gl_imports::libc::c_int) -> () { __gl_imports::mem::transmute::<_, extern "system" fn(types::Font, __gl_imports::libc::c_int, __gl_imports::libc::c_int, __gl_imports::libc::c_int) -> ()>(self.UseXFont.f)(font, first, count, list) }
#[allow(non_snake_case)] #[allow(unused_variables)] #[allow(dead_code)]
