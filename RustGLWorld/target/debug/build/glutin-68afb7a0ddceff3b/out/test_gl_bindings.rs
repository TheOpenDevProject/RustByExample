...
impl Gles2 {
            ...
            pub fn load_with<F>(mut loadfn: F) -> Gles2 where F: FnMut(&str) -> *const __gl_imports::libc::c_void {
...
Viewport: FnPtr::new(metaloadfn("glViewport", &[])),
        ...
        #[allow(dead_code)]
        #[allow(unused_variables)]
        pub fn load<T: __gl_imports::gl_common::GlFunctionsSource>(loader: &T) -> Gles2 {
            Gles2::load_with(|name| loader.get_proc_addr(name))
        }
